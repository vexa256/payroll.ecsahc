<div class="row">
    ...
    <div class="col-12">
        ...
        {{ HeaderBtn($Toggle = 'New', $Class = 'btn-danger float-end', $Label = 'New Percentage Benefit', $Icon = 'fa-plus') }}
    </div>
...
@include('PercentageBenefits.NewPercentageBenefits')
    ...
    @foreach ($DatabaseData as $up)
        ...
        <form action="{{ route('MassUpdate') }}" class="" method="POST">
            ...
            <div class="row">
                ...
                <input type="hidden" name="TableName" value="percentage_benefits">

                {{ RunUpdateModalFinal($ModalID = $up->id, $Extra = '', $csrf = null, $Title = null, $RecordID = $up->id, $col = '4', $te = '12', $TableName = 'percentage_benefits') }}
            </div>
