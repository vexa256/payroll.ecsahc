<div class="row">
    ...
    <div class="col-12">
        ...
        {{ HeaderBtn($Toggle = 'New', $Class = 'btn-danger float-end', $Label = 'New Tax', $Icon = 'fa-plus') }}
    </div>
    ...
    @foreach ($DatabaseData as $up)
        ...
        <form action="{{ route('MassUpdate') }}" class="" method="POST">
            ...
            <div class="row">
                ...
                {{ RunUpdateModalFinal($ModalID = $up->id, $Extra = '', $csrf = null, $Title = null, $RecordID = $up->id, $col = '4', $te = '12', $TableName = 'taxes') }}
            </div>
