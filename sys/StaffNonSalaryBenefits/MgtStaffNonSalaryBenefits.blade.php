...
@include('StaffNonSalaryBenefits.NewBenefit')
        ...
        <form action="{{ route('MassUpdate') }}" class="" method="POST">
            ...
            <div class="row">
                ...
                <input type="hidden" name="TableName"
                    value="staff_non_salary_benefits">

                {{ RunUpdateModalFinal($ModalID = $up->id, $Extra = '', $csrf = null, $Title = null, $RecordID = $up->id, $col = '4', $te = '12', $TableName = 'staff_non_salary_benefits') }}
            </div>
