<div class="modal fade" id="NewPB">
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-gray">
                <h5 class="modal-title">Attach a percentage benefit to the
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-3  ">
                            ...
                            <select required name="BID"
                                ...
                                <option></option>
                                @isset($percentage_benefits)

                                    @foreach ($percentage_benefits as $data)
                                        <option value="{{ $data->PBID }}">
                                            {{ $data->Benefit }}</option>
                                    @endforeach
                                @endisset
