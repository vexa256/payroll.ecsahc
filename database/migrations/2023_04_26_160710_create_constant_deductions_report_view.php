...
return new class extends Migration
{
    ...
    {
        \DB::statement("CREATE VIEW `constant_deductions_report_view` AS
        SELECT
            e.EmpID,
            dA.id,
            dA.ValidTo,
            ...
            e.JoiningDate,
            e.ContractExpiry,
            SUM(cD.Amount) AS TotalConstantDeductions,
    ...
    {
        Schema::dropIfExists('constant_deductions_report_view');
    }
};
