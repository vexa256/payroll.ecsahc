...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("CREATE VIEW `constant_benefits_report_view` AS
            SELECT
                e.EmpID,
                bA.id,
                bA.ValidTo,
                ...
                cB.Description,
                cB.Amount,
                SUM(cB.Amount) OVER (PARTITION BY e.EmpID) AS TotalConstantBenefits,
    ...
    {
        Schema::dropIfExists('constant_benefits_report_view');
    }
};
